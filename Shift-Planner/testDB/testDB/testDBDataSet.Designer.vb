...
Partial Public Class testDBDataSet
    ...
    Partial Public Class tblEmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddtblEmployeeRow(ByVal FName As String, ByVal SName As String) As tblEmployeeRow
            Dim rowtblEmployeeRow As tblEmployeeRow = CType(Me.NewRow,tblEmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, FName, SName}
    ...
    Partial Public Class tblEmployeeRow
        ...
        Public Property SName() As String
            Get
                Try 
                    Return CType(Me(Me.tabletblEmployee.SNameColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'SName' in table 'tblEmployee' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tabletblEmployee.SNameColumn) = value
            End Set
        End Property
        ...
        Public Function IsSNameNull() As Boolean
            Return Me.IsNull(Me.tabletblEmployee.SNameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetSNameNull()
            Me(Me.tabletblEmployee.SNameColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class tblEmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `tblEmployee` WHERE ((`employeeID` = ?) AND ((? = 1 AND `FName` IS NU"& _ 
                "LL) OR (`FName` = ?)) AND ((? = 1 AND `SName` IS NULL) OR (`SName` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `tblEmployee` (`FName`, `SName`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `tblEmployee` SET `FName` = ?, `SName` = ? WHERE ((`employeeID` = ?) AND ("& _ 
                "(? = 1 AND `FName` IS NULL) OR (`FName` = ?)) AND ((? = 1 AND `SName` IS NULL) O"& _ 
                "R (`SName` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.testDB.My.MySettings.Default.testDBConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT employeeID, FName, SName FROM tblEmployee"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As testDBDataSet.tblEmployeeDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As testDBDataSet.tblEmployeeDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As testDBDataSet.tblEmployeeDataTable = New testDBDataSet.tblEmployeeDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As testDBDataSet.tblEmployeeDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_employeeID As Integer, ByVal Original_FName As String, ByVal Original_SName As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal FName As String, ByVal SName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FName As String, ByVal SName As String, ByVal Original_employeeID As Integer, ByVal Original_FName As String, ByVal Original_SName As String) As Integer
            If (FName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_FName,String)
            End If
            If (Original_SName Is Nothing) Then
